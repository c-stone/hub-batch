...
module.exports = (function() {
  function makeUpdateBufferRequest(answersObj) {
  ...
  function putContentUpdates(pageData) {
    ...
    var options = {
      method: 'PUT',
      url: 'http://api.hubapi.com/content/api/v2/'+ cosContentType +'/'+ pageId  +'/buffer',
      qs: queryString,
  ...
  return {
    makeUpdateBufferRequest: makeUpdateBufferRequest,
  };
})();
