...
module.exports = (function() {
  function makePushBufferLiveRequest(answersObj) {
  ...
  function putContentUpdates(pageData) {
    ...
    var options = {
      method: 'POST',
      url: 'http://api.hubapi.com/content/api/v2/'+ cosContentType +'/'+ pageId  +'/push-buffer-live',
      qs: queryString,
  ...
  return {
    makePushBufferLiveRequest: makePushBufferLiveRequest,
  };
})();
