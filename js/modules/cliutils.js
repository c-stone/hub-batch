  ...
  getUserPreferences: function(callback) {
    var questions = [
      ...
      },
      {
        ...
        choices: ['GET JSON', 'Update Buffer JSON', 'Push Buffer Live', 'Update Hard Object JSON', 'Publish Action', 'Rollback Hard Object JSON']
      },
        // Begin GET Options
      ...
      { // If UPDATE, BUFFER, PUSHBUFFERLIVE or PUBLISH are selected
        ...
        when: answers => (answers.method === 'Update Hard Object JSON' || answers.method === 'Publish Action' || answers.method === 'Update Buffer JSON' || answers.method === 'Push Buffer Live')
      },
